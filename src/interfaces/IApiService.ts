...
export interface IApiService {
    ...
    get(url: string, directives?: any, bearerToken?: string): Promise<ApiRequestResult>;
    ...
    /// <param name="directives">The directives to use for the request, this can be anything depending on the specific implementation.</param>
    /// <returns>The result of the request.</returns>
    post(url: string, data?: any, directives?: any, bearerToken?: string): Promise<ApiRequestResult>;
    ...
    /// <param name="directives">The directives to use for the request, this can be anything depending on the specific implementation.</param>
    /// <returns>The result of the request.</returns>
    put(url: string, data: any, directives?: any, bearerToken?: string): Promise<ApiRequestResult>;
    ...
    /// <param name="directives">The directives to use for the request, this can be anything depending on the specific implementation.</param>
    /// <returns>The result of the request.</returns>
    patch(url: string, data: any, directives?: any, bearerToken?: string): Promise<ApiRequestResult>;
    ...
    /// <param name="directives">The directives to use for the request, this can be anything depending on the specific implementation.</param>
    /// <returns>The result of the request.</returns>
    delete(url: string, directives?: any, bearerToken?: string): Promise<ApiRequestResult>;
}